...
describe('GetPurchase', () => {
    ...
    it('should be defined', () => {
        expect(getPurchase).toBeDefined();
    });
    ...
    it('should return a purchase', async () => {
        ...
        const output = await getPurchase.execute({
            id: purchaseOutput.id,
        });

        expect(output).toHaveProperty('id', purchaseOutput.id);
        expect(output).toHaveProperty('date', purchaseOutput.date);
        expect(output).toHaveProperty('supplierId', supplier.id);
        expect(output).toHaveProperty('items', itemsPurchaseOutput.items);
        expect(output).toHaveProperty('volume', itemsPurchaseOutput.volume);
        expect(output).toHaveProperty(
            'totalValue',
            itemsPurchaseOutput.totalValue,
        );
    });
});
